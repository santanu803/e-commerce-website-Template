...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="div1">
     ...
     <%--    <asp:LinkButton ID="btnAll" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="btnAll_Click">All catagories </asp:LinkButton><br />
        ...
        <asp:LinkButton ID="btnCookies" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="btnCookies_Click">Cookies</asp:LinkButton><br />
       --%>
        <asp:LinkButton ID="btnAll" runat="server" Font-Bold="True" Font-Size="Medium" OnClick="btnAll_Click">All Items</asp:LinkButton>
...
<asp:DataList ID="DataList1" runat="server" DataKeyField="itemid" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal">
    ...
    <ItemTemplate>
        ...
        <br />
          ...
          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DbCon %>" SelectCommand="SELECT * FROM [tblItem] WHERE subcat=@ct">
              
              <SelectParameters>
                  <asp:Parameter DefaultValue="Grocary" Name="category" Type="String" />

                  <asp:QueryStringParameter Name="ct" QueryStringField="subcat" />
